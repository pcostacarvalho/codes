#cria os arquivos uppar e dwpar 
...
more uppar.es.$name >> uppar
for i in $(seq 21 38); do more uppar.pd.$name >> uppar; done
...
more dwpar.es.$name >> dwpar
for i in $(seq 21 38); do more dwpar.pd.$name >> dwpar; done
